            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav navbar-sidenav" id="exampleAccordion" style="background-color: whitesmoke !important;box-shadow: 0 10px 20px rgba(0,0,0,0.19), 0 6px 6px rgba(0,0,0,0.23)">
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                        <a class="nav-link dashboard" href="dashboardcontroller.jsp">
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    ...
                    <div class="list-group list-group-flush small">
                        <jsp:include page="/DashboardConController" />
                        ...
                        <div class="modal-dialog" role="document" style="max-width: 850px">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer button">
                                    ...
                                    <a class="btn btn-primary suggestionclose" style="color: white"><i class="fa fa-fw fa-close"></i>&nbsp;Close</a>
